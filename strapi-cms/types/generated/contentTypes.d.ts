...
export interface ApiFaqItemFaqItem extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Frequently asked question content.';
...
export interface ApiIeltsInfoPageIeltsInfoPage
  extends Struct.CollectionTypeSchema {
  collectionName: 'ielts_info_pages';
  info: {
    description: 'Fees, centers, preparation guides, referral terms, and other IELTS information pages.';
    displayName: 'IELTS Info Page';
    pluralName: 'ielts-info-pages';
    singularName: 'ielts-info-page';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::ielts-info-page.ielts-info-page'
    > &
      Schema.Attribute.Private;
...
export interface ApiMockTestSectionMockTestSection
  extends Struct.CollectionTypeSchema {
  collectionName: 'mock_test_sections';
  info: {
    description: 'Ordered IELTS module section inside a mock test.';
    displayName: 'Mock Test Section';
    pluralName: 'mock-test-sections';
    singularName: 'mock-test-section';
  };
  options: {
    draftAndPublish: false;
  };
...
export interface ApiMockTestMockTest extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'short_mock'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiQuestionGroupQuestionGroup
  ...
  info: {
    description: 'Grouped IELTS questions with shared instructions or display config.';
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    questions: Schema.Attribute.Relation<'oneToMany', 'api::question.question'>;
    questionType: Schema.Attribute.String & Schema.Attribute.Required;
...
export interface ApiQuestionQuestion extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'IELTS question with options, answer key, explanation, and attribution.';
  ...
  attributes: {
    answerKey: Schema.Attribute.Component<'tests.answer-key', false>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::ielts-info-page.ielts-info-page': ApiIeltsInfoPageIeltsInfoPage;
      'api::mock-test-section.mock-test-section': ApiMockTestSectionMockTestSection;
      'api::mock-test.mock-test': ApiMockTestMockTest;
