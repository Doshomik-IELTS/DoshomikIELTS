...
// ../node_modules/.pnpm/@strapi+content-type-builder@5.46.0_022ec6a24b75ab97ce8f278e4673eb1f/node_modules/@strapi/content-type-builder/dist/admin/translations/sv.json.mjs
...
var sv = {
  ...
  "table.content.create-first-content-type.start-with-prompt": "Börja med en uppmaning",
  ...
  "chat.tooltips.close-chat": "Stäng chatt",
  "chat.tooltips.create-chat": "Ny konversation",
  "chat.tooltips.open-chat": "Öppna chatt",
  "chat.tooltips.send-message": "Skicka",
  "chat.tooltips.stop-generation": "Stoppa",
  "chat.header.default-title": "Ny konversation",
  "chat.input.defaults.title": "Hur kan jag hjälpa dig?",
  "chat.input.defaults.generate": "Generera en produktschema",
  "chat.input.defaults.ctb": "Berätta om Content-Type Builder",
  "chat.input.defaults.strapi": "Berätta om Strapi",
  "chat.input.thinking": "Strapi AI tänker...",
  "chat.input.placeholder": "Fråga Strapi AI...",
  "chat.input.strapi-ai-can-make-errors": "Strapi AI kan göra fel.",
  "chat.messages.error": "Något gick fel.",
  "chat.code-upload.header": "Importera en Next.js-app",
  "chat.code-upload.title": "Importera en Next.js-app",
  "chat.code-upload.description": "Din app kommer att analyseras av AI. Se till att ta bort all känslig data före import.",
  "chat.code-upload.drop-zone": "Släpp .zip-filen här eller",
  "chat.code-upload.drop-zone-browse": "bläddra bland filer"
};
export {
  configurations,
  sv as default,
...
//# sourceMappingURL=sv.json-YRKQLDX6.js.map
