...
// ../node_modules/.pnpm/@strapi+content-type-builder@5.46.0_022ec6a24b75ab97ce8f278e4673eb1f/node_modules/@strapi/content-type-builder/dist/admin/translations/ms.json.mjs
...
var ms = {
  ...
  "attribute.blocks": "Teks beraneka (Blok)",
  "attribute.blocks.description": "Penyunting teks beraneka berasaskan JSON",
  "attribute.text": "Teks",
  ...
  "button.component.create": "Tambah komponen baru",
  ...
  "components.SelectComponents.displayed-value": "{number, plural, =0 {# komponen} one {# komponen} other {# komponen}} dipilih",
  ...
  configurations,
  "contentType.apiId-plural.description": "API ID dalam bentuk jamak",
  "contentType.apiId-plural.label": "API ID (Jamak)",
  "contentType.apiId-singular.description": "UID digunakan untuk menjana laluan API dan jadual/koleksi pangkalan data",
  "contentType.apiId-singular.label": "API ID (Tunggal)",
  ...
  "error.contentType.pluralName-used": "Nilai ini tidak boleh sama dengan nilai tunggal",
  "error.contentType.singularName-used": "Nilai ini tidak boleh sama dengan nilai jamak",
  "error.contentType.singularName-equals-pluralName": "Nilai ini tidak boleh sama dengan API ID Jamak jenis kandungan lain.",
  "error.contentType.pluralName-equals-singularName": "Nilai ini tidak boleh sama dengan API ID Tunggal jenis kandungan lain.",
  "error.contentType.pluralName-equals-collectionName": "Nilai ini sudah digunakan oleh jenis kandungan lain.",
  ...
  "error.validation.enum-duplicate": "Nilai yang sama tidak dibenarkan (hanya aksara alfanumerik diambil kira).",
  "error.validation.enum-empty-string": "String kosong tidak dibenarkan",
  "error.validation.enum-regex": "Sekurang-kurangnya satu nilai tidak sah. Nilai harus mempunyai sekurang-kurangnya satu aksara abjad sebelum kemunculan pertama nombor.",
  "error.validation.minSupMax": "Tidak boleh lebih dari maksimum",
  "error.validation.positive": "Mesti nombor positif",
  ...
  "form.attribute.component.option.create": "Cipta komponen baru",
  ...
  "form.attribute.item.date.type.date": "tarikh (cth: 01/01/{currentYear})",
  "form.attribute.item.date.type.datetime": "masa tarikh (cth: 01/01/{currentYear} 00:00 AM)",
  "form.attribute.item.date.type.time": "masa (cth: 00:00 AM)",
  ...
  "form.attribute.item.uniqueField.v5.willBeDisabled": "Pada masa ini, ruang unik tidak berfungsi dengan baik dalam komponen. Jika anda menyahaktifkan ciri ini, ruang tersebut akan dinyahaktifkan sehingga ia diperbaiki.",
  "form.attribute.item.uniqueField.v5.disabled": "Pada masa ini, ruang unik tidak berfungsi dengan baik dalam komponen. Ruang ini telah dinyahaktifkan sehingga ia diperbaiki.",
  ...
  "form.button.collection-type.name": "Jenis Koleksi",
  ...
  "form.button.single-type.name": "Jenis Tunggal",
  from,
  "menu.section.components.name": "Komponen",
  "menu.section.models.name": "Jenis Koleksi",
  "menu.section.single-types.name": "Jenis Tunggal",
  ...
  "modalForm.collectionType.header-create": "Cipta Jenis Koleksi",
  ...
  "modalForm.empty.button": "Tambah Custom field",
  "modalForm.empty.heading": "Tiada apa-apa di sini lagi",
  "modalForm.empty.sub-heading": "Cari apa yang anda cari melalui pelbagai plugin.",
  ...
  "modalForm.custom-fields.advanced.settings.extended": "Tetapan lanjutan",
  "modalForm.tabs.custom": "Custom",
  "modalForm.tabs.custom.howToLink": "Cara menambah Custom field",
  "modalForm.tabs.default": "Lalai",
  "modalForm.tabs.label": "Label jenis lalai dan Custom",
  "modelPage.attribute.relation-polymorphic": "Perhubung (polimorfik)",
  "modelPage.attribute.relationWith": "Terhubung dengan",
  "notification.error.dynamiczone-min.validation": "Anda perlu sekurang-kurangnya satu komponen dalam Zon Dinamik untuk menyimpan jenis kandungan",
  ...
  "notification.info.creating.notSaved": "Sila simpan kerja anda sebelum membuat jenis kandungan atau komponen baru",
  "plugin.description.long": "Modelkan struktur data untuk API anda. Buat ruang dan hubungan baru dalam satu minit. Fail dibuat dan dikemas kini secara automatik dalam projek anda.",
  "plugin.description.short": "Modelkan struktur data untuk API anda.",
  "plugin.name": "Content-Type Builder",
  "popUpForm.navContainer.advanced": "Tetapan lanjutan",
  ...
  "popUpWarning.bodyMessage.cancel-modifications.with-components": "Adakah anda pasti mahu membatalkan pengubahsuaian anda? Beberapa komponen telah dibuat atau diubah suai...",
  "popUpWarning.bodyMessage.category.delete": "Adakah anda pasti mahu memadamkan kategori ini? Semua komponen akan dipadam juga.",
  ...
  "popUpWarning.draft-publish.button.confirm": "Ya, nyahaktifkan",
  "popUpWarning.draft-publish.message": "Jika anda menyahaktifkan Draf & terbit, draf anda akan dipadam.",
  "popUpWarning.draft-publish.second-message": "Adakah anda pasti mahu menyahaktifkannya?",
  "prompt.unsaved": "Adakah anda pasti mahu meninggalkan halaman ini? Semua pengubahsuaian anda akan hilang.",
  "relation.attributeName.placeholder": "Cth: penulis, kategori, tag",
  "relation.manyToMany": "mempunyai dan milik kepada banyak",
  "relation.manyToOne": "mempunyai banyak",
  "relation.manyWay": "mempunyai banyak",
  "relation.oneToMany": "milik kepada banyak",
  "relation.oneToOne": "mempunyai dan milik kepada satu",
  "relation.oneWay": "mempunyai satu",
  "table.button.no-fields": "Tambah ruang baru",
  "table.content.create-first-content-type.title": "Tiada jenis kandungan",
  "table.content.create-first-content-type.description": "Buat jenis koleksi, jenis tunggal dan komponen untuk membina skema anda.",
  "table.content.create-first-content-type.start-with-prompt": "Mulakan dengan prompt",
  "table.content.no-fields.collection-type": "Tambah ruang pertama ke jenis koleksi ini",
  "table.content.no-fields.component": "Tambah ruang pertama ke komponen ini",
  "IconPicker.search.placeholder.label": "Cari ikon",
  "IconPicker.search.clear.label": "Kosongkan carian ikon",
  "IconPicker.search.button.label": "Butang carian ikon",
  "IconPicker.remove.tooltip": "Buang ikon yang dipilih",
  "IconPicker.remove.button": "Butang buang ikon yang dipilih",
  "IconPicker.emptyState.label": "Tiada ikon dijumpai",
  "IconPicker.icon.label": "Pilih ikon {icon}",
  "chat.tooltips.close-chat": "Tutup perbualan",
  "chat.tooltips.create-chat": "Perbualan baru",
  "chat.tooltips.open-chat": "Buka perbualan",
  "chat.tooltips.send-message": "Hantar",
  "chat.tooltips.stop-generation": "Berhenti",
  "chat.header.default-title": "Perbualan baru",
  "chat.input.defaults.title": "Bagaimana saya boleh bantu anda?",
  "chat.input.defaults.generate": "Jana skema produk",
  "chat.input.defaults.ctb": "Beritahu saya tentang Content-Type Builder",
  "chat.input.defaults.strapi": "Beritahu saya tentang Strapi",
  "chat.input.thinking": "Strapi AI sedang berfikir...",
  "chat.input.placeholder": "Tanya Strapi AI...",
  "chat.input.strapi-ai-can-make-errors": "Strapi AI boleh membuat kesilapan.",
  "chat.messages.error": "Sesuatu telah berlaku.",
  "chat.code-upload.header": "Import aplikasi Next.js",
  "chat.code-upload.title": "Import aplikasi Next.js",
  "chat.code-upload.description": "Aplikasi anda akan dianalisis oleh AI. Pastikan untuk membuang semua data sensitif sebelum pengimportan.",
  "chat.code-upload.drop-zone": "Letakkan fail .zip di sini atau",
  "chat.code-upload.drop-zone-browse": "semak fail"
};
export {
  configurations,
  ms as default,
...
//# sourceMappingURL=ms.json-C7OYUWPK.js.map
