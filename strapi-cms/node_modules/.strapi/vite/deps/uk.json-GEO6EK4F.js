...
// ../node_modules/.pnpm/@strapi+content-type-builder@5.46.0_022ec6a24b75ab97ce8f278e4673eb1f/node_modules/@strapi/content-type-builder/dist/admin/translations/uk.json.mjs
...
var uk = {
  ...
  "table.content.create-first-content-type.start-with-prompt": "Почати з підказки",
  "chat.tooltips.close-chat": "Закрити чат",
  "chat.tooltips.create-chat": "Нова розмова",
  "chat.tooltips.open-chat": "Відкрити чат",
  "chat.tooltips.send-message": "Надіслати",
  "chat.tooltips.stop-generation": "Зупинити",
  "chat.header.default-title": "Нова розмова",
  "chat.input.defaults.title": "Чим я можу вам допомогти?",
  "chat.input.defaults.generate": "Згенерувати schema продукту",
  "chat.input.defaults.ctb": "Розкажіть мені про Content-Type Builder",
  "chat.input.defaults.strapi": "Розкажіть мені про Strapi",
  "chat.input.thinking": "Strapi AI думає...",
  "chat.input.placeholder": "Запитайте Strapi AI...",
  "chat.input.strapi-ai-can-make-errors": "Strapi AI може робити помилки.",
  "chat.messages.error": "Щось пішло не так.",
  "chat.code-upload.header": "Імпортувати додаток Next.js",
  "chat.code-upload.title": "Імпортувати додаток Next.js",
  "chat.code-upload.description": "Ваш додаток буде проаналізовано AI.  Перед імпортом видаліть усі конфіденційні дані.",
  "chat.code-upload.drop-zone": "Перетягніть .zip файл сюди або",
  "chat.code-upload.drop-zone-browse": "виберіть файли",
  "table.button.no-fields": "Додати нове поле",
...
//# sourceMappingURL=uk.json-GEO6EK4F.js.map
