...
// ../node_modules/.pnpm/@strapi+content-type-builder@5.46.0_022ec6a24b75ab97ce8f278e4673eb1f/node_modules/@strapi/content-type-builder/dist/admin/translations/ja.json.mjs
...
var ja = {
  ...
  "attribute.component.description": "繰り返しや再利用ができるフィールドのグループ",
  "attribute.customField": "カスタムフィールド",
  "attribute.date": "Date",
  "attribute.date.description": "時間、分、秒を含む日付ピッカー",
  "attribute.datetime": "日時",
  "attribute.dynamiczone": "ダイナミックゾーン",
  "attribute.dynamiczone.description": "コンテンツの編集時にコンポーネントを動的に選択",
  "attribute.email": "Email",
  "attribute.email.description": "バリデーション形式を持つEmailフィールド",
  "attribute.enumeration": "Enumeration",
  "attribute.enumeration.description": "値のリストから1つを選択",
  "attribute.json": "JSON",
  "attribute.json.description": "JSON形式のデータ",
  "attribute.media": "Media",
  "attribute.media.description": "画像、動画などのファイル",
  "attribute.null": " ",
  "attribute.number": "数値",
  "attribute.number.description": "数値（整数、浮動小数点、小数）",
  "attribute.password": "Password",
  "attribute.password.description": "暗号化されたパスワードフィールド",
  ...
  "attribute.time": "時間",
  "attribute.timestamp": "タイムスタンプ",
  "attribute.uid": "UID",
  "attribute.uid.description": "一意の識別子",
  "button.attributes.add.another": "別のフィールドを追加",
  "button.component.add": "コンポーネントを追加",
  ...
  "contentType.apiId-singular.description": "UIDはAPIルートとデータベーステーブル/コレクションの生成に使用されます",
  "contentType.apiId-singular.label": "API ID（単数形）",
  "contentType.collectionName.description": "Content Typeの名前とテーブル名が異なる場合に便利です",
  "contentType.collectionName.label": "コレクション名",
  ...
  "error.validation.enum-regex": "少なくとも1つの値が無効です。値は数字の最初の出現の前に少なくとも1つのアルファベット文字を持つ必要があります。",
  "error.validation.minSupMax": "最小値は最大値より大きくできません",
  "error.validation.positive": "正の数でなければなりません",
  "error.validation.regex": "正規表現パターンが無効です",
  "error.validation.relation.targetAttribute-taken": "この名前はターゲットに存在します",
  "form.attribute.component.option.add": "コンポーネントを追加",
  "form.attribute.component.option.create": "新しいコンポーネントを作成",
  "form.attribute.component.option.create.description": "コンポーネントはタイプとコンポーネント間で共有され、どこでも利用可能でアクセス可能になります。",
  "form.attribute.component.option.repeatable": "繰り返し可能なコンポーネント",
  "form.attribute.component.option.repeatable.description": "材料、メタタグなどの複数のインスタンス（配列）に最適です。",
  "form.attribute.component.option.reuse-existing": "既存のコンポーネントを使用",
  ...
  "form.attribute.item.date.type.datetime": "日時 (例: 01/01/{currentYear} 00:00 AM)",
  "form.attribute.item.date.type.time": "時間 (例: 00:00 AM)",
  ...
  "form.attribute.item.number.type.decimal": "decimal (例: 2.22)",
  "form.attribute.item.number.type.float": "float (例: 3.33333333)",
  "form.attribute.item.number.type.integer": "integer (例: 10)",
  "form.attribute.item.privateField": "プライベートフィールド",
  "form.attribute.item.privateField.description": "このフィールドはAPIレスポンスに表示されません",
  "form.attribute.item.requiredField": "必須フィールド",
  "form.attribute.item.requiredField.description": "このフィールドが空の場合、エントリを作成することはできません",
  "form.attribute.item.text.regex": "RegExpパターン",
  ...
  "form.attribute.media.allowed-types.option-videos": "動画",
  "form.attribute.media.option.multiple": "複数メディア",
  "form.attribute.media.option.multiple.description": "スライダー、カルーセル、複数ファイルのダウンロードに最適",
  "form.attribute.media.option.single": "単一メディア",
  "form.attribute.media.option.single.description": "アバター、プロフィール写真、カバーに最適",
  "form.attribute.settings.default": "デフォルト値",
  "form.attribute.text.option.long-text": "長いテキスト",
  "form.attribute.text.option.long-text.description": "説明、経歴などに最適。正確な検索は無効です。",
  "form.attribute.text.option.short-text": "短いテキスト",
  "form.attribute.text.option.short-text.description": "タイトル、名前、リンク（URL）に最適。フィールドでの正確な検索も可能です。",
  "form.button.add-components-to-dynamiczone": "ゾーンにコンポーネントを追加",
  "form.button.add-field": "別のフィールドを追加",
  "form.button.add-first-field-to-created-component": "コンポーネントに最初のフィールドを追加",
  "form.button.add.field.to.collectionType": "このCollection Typeに別のフィールドを追加",
  ...
  "modalForm.attributes.select-component": "コンポーネントを選択",
  "modalForm.attributes.select-components": "コンポーネントを選択",
  "modalForm.collectionType.header-create": "Collection Typeを作成",
  ...
  "modalForm.sub-header.attribute.create.step": "新しいコンポーネントを追加 ({step}/2)",
  "modalForm.sub-header.attribute.edit": "{name}を編集",
  ...
  "popUpWarning.bodyMessage.cancel-modifications.with-components": "変更をキャンセルしてもよろしいですか？一部のコンポーネントが作成または変更されています...",
...
//# sourceMappingURL=ja.json-VQACBYNW.js.map
