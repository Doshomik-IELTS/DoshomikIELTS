...
// ../node_modules/.pnpm/@strapi+content-type-builder@5.46.0_022ec6a24b75ab97ce8f278e4673eb1f/node_modules/@strapi/content-type-builder/dist/admin/translations/zh.json.mjs
...
var zh = {
  ...
  "chat.tooltips.create-chat": "新的对话",
  "chat.tooltips.open-chat": "打开聊天",
  "chat.tooltips.send-message": "发送",
  "chat.tooltips.stop-generation": "停止",
  "chat.header.default-title": "新的对话",
  "chat.input.defaults.title": "我能为您做什么？",
  "chat.input.defaults.generate": "生成产品 schema",
  "chat.input.defaults.ctb": "介绍一下 Content-Type Builder",
  "chat.input.defaults.strapi": "介绍一下 Strapi",
  ...
  "chat.messages.error": "出了些问题。",
  "chat.code-upload.header": "导入 Next.js 应用",
  "chat.code-upload.title": "导入 Next.js 应用",
  "chat.code-upload.description": "您的应用将由 AI 进行分析。 导入前请务必删除所有敏感数据。",
  "chat.code-upload.drop-zone": "将 .zip 文件拖放到此处或",
...
//# sourceMappingURL=zh.json-NJGN3Q2F.js.map
