...
var admin2 = {
  register(app) {
    app.addMenuLink({
      ...
      Component: () => {
        return import("./App-CRQHOVS7.js").then((mod) => ({
          default: mod.Upload
        }));
      },
      position: 4
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled("cms-content-releases")) {
      app.addMenuLink({
        ...
        Component: () => import("./App-2OLBB4UX.js").then((mod) => ({
          default: mod.App
        })),
    ...
    if (window.strapi.features.isEnabled(FEATURE_ID)) {
      ...
      app.widgets.register((widgets) => [
        ...widgets,
        {
          ...
          component: async () => {
            const { AssignedWidget } = await import("./Widgets-6QS4QN5S.js");
...
//# sourceMappingURL=chunk-6QB4VTZB.js.map
