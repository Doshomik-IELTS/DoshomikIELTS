...
// ../node_modules/.pnpm/@strapi+content-type-builder@5.46.0_022ec6a24b75ab97ce8f278e4673eb1f/node_modules/@strapi/content-type-builder/dist/admin/translations/tr.json.mjs
...
var tr = {
  ...
  "table.content.create-first-content-type.start-with-prompt": "Bir istem ile başla",
  ...
  "chat.tooltips.close-chat": "Sohbeti kapat",
  "chat.tooltips.create-chat": "Yeni konuşma",
  "chat.tooltips.open-chat": "Sohbeti aç",
  "chat.tooltips.send-message": "Gönder",
  "chat.tooltips.stop-generation": "Durdur",
  "chat.header.default-title": "Yeni konuşma",
  "chat.input.defaults.title": "Size nasıl yardımcı olabilirim?",
  "chat.input.defaults.generate": "Bir ürün schema'sı oluştur",
  "chat.input.defaults.ctb": "Bana Content-Type Builder hakkında bilgi ver",
  "chat.input.defaults.strapi": "Bana Strapi hakkında bilgi ver",
  "chat.input.thinking": "Strapi AI düşünüyor...",
  "chat.input.placeholder": "Strapi AI'ya sor...",
  "chat.input.strapi-ai-can-make-errors": "Strapi AI hata yapabilir.",
  "chat.messages.error": "Bir şeyler ters gitti.",
  "chat.code-upload.header": "Next.js uygulamasını içe aktar",
  "chat.code-upload.title": "Next.js uygulamasını içe aktar",
  "chat.code-upload.description": "Uygulamanız AI tarafından analiz edilecek. İçe aktarmadan önce tüm hassas verileri kaldırdığınızdan emin olun.",
  "chat.code-upload.drop-zone": ".zip dosyasını buraya bırakın veya",
  "chat.code-upload.drop-zone-browse": "dosyalara göz atın"
};
export {
  configurations,
  tr as default,
...
//# sourceMappingURL=tr.json-KKQ6RQWX.js.map
