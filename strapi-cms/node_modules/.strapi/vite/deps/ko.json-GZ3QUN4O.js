...
// ../node_modules/.pnpm/@strapi+content-type-builder@5.46.0_022ec6a24b75ab97ce8f278e4673eb1f/node_modules/@strapi/content-type-builder/dist/admin/translations/ko.json.mjs
...
var ko = {
  ...
  "attribute.relation.description": "Collection Type을 참조하는 필드",
  "attribute.richtext": "서식있는 텍스트(Rich text)",
  "attribute.richtext.description": "서식 옵션이 있는 리치 텍스트 에디터",
  "attribute.blocks": "서식있는 텍스트(Rich text)",
  "attribute.blocks.description": "JSON 기반 리치 텍스트 에디터",
  ...
  "button.model.create": "새 Collection Type 생성",
  "button.single-types.create": "새 Single Type 생성",
  ...
  "components.componentSelect.value-component": "{number} 컴포넌트 선택됨 (컴포넌트 검색하려면 입력하세요)",
  ...
  "error.contentType.singularName-equals-pluralName": "이 값은 다른 콘텐츠 타입의 복수 API ID와 같을 수 없습니다",
  "error.contentType.pluralName-equals-singularName": "이 값은 다른 콘텐츠 타입의 단수 API ID와 같을 수 없습니다",
  "error.contentType.pluralName-equals-collectionName": "이 값은 이미 다른 콘텐츠 타입에서 사용 중입니다",
  ...
  "error.validation.enum-regex": "적어도 하나의 값이 유효하지 않습니다. 값은 숫자가 처음 나타나기 전에 적어도 하나의 알파벳 문자를 포함해야 합니다",
  ...
  "form.attribute.item.date.type.date": "날짜 (예: 01/01/{currentYear})",
  "form.attribute.item.date.type.datetime": "날짜 시간 (예: 01/01/{currentYear} 00:00 AM)",
  "form.attribute.item.date.type.time": "시간 (예: 00:00 AM)",
  ...
  "form.attribute.item.uniqueField.v5.willBeDisabled": "현재 컴포넌트의 고유 필드는 제대로 작동하지 않습니다. 이것을 활성화하면 수정될 때까지 필드가 비활성화됩니다",
  "form.attribute.item.uniqueField.v5.disabled": "현재 컴포넌트의 고유 필드는 제대로 작동하지 않습니다. 이 필드는 수정될 때까지 비활성화됩니다",
  ...
  "form.button.add.field.to.collectionType": "이 Collection Type에 다른 필드 추가하기",
  "form.button.add.field.to.component": "이 컴포넌트에 다른 필드 추가하기",
  "form.button.add.field.to.contentType": "이 콘텐츠 타입에 다른 필드 추가하기",
  "form.button.add.field.to.singleType": "이 Single Type에 다른 필드 추가하기",
  ...
  "modalForm.collectionType.header-create": "Collection Type 생성",
  ...
  "modalForm.empty.button": "커스텀 필드 추가",
  "modalForm.empty.heading": "아직 여기에 아무것도 없습니다.",
  "modalForm.empty.sub-heading": "다양한 플러그인을 통해 원하는 것을 찾아보세요.",
  ...
  "modalForm.singleType.header-create": "Single Type 생성",
  ...
  "modalForm.sub-header.chooseAttribute.collectionType": "Collection Type에 추가할 필드를 선택해주세요.",
  "modalForm.sub-header.chooseAttribute.component": "컴포넌트에 추가할 필드를 선택해주세요.",
  "modalForm.sub-header.chooseAttribute.singleType": "Single Type에 추가할 필드를 선택해주세요.",
  "modalForm.custom-fields.advanced.settings.extended": "확장 설정",
  "modalForm.tabs.custom": "커스텀",
  "modalForm.tabs.custom.howToLink": "커스텀 필드 추가 방법",
  "modalForm.tabs.default": "기본",
  "modalForm.tabs.label": "기본 및 커스텀 타입 레이블",
  "modelPage.attribute.relation-polymorphic": "릴레이션 (polymorphic)",
  "modelPage.attribute.relationWith": "관계",
  "notification.error.dynamiczone-min.validation": "콘텐츠 타입을 저장하려면 다이나믹 존에 적어도 하나의 컴포넌트가 필요합니다",
  "notification.info.autoreaload-disable": "이 플러그인을 사용하려면 autoReload 기능이 필요합니다. `strapi develop`로 서버를 시작해주세요.",
  "notification.info.creating.notSaved": "새 콘텐츠 타입 또는 컴포넌트를 만들기 전에 작업을 저장해주세요.",
  ...
  "table.content.create-first-content-type.title": "콘텐츠 타입 없음",
  "table.content.create-first-content-type.description": "Collection Types, Single Types 및 컴포넌트를 생성하여 스키마를 구축하세요.",
  "table.content.create-first-content-type.start-with-prompt": "프롬프트로 시작하기",
  "table.content.no-fields.collection-type": "Collection Type에 첫 필드를 추가해보세요.",
  "table.content.no-fields.component": "컴포넌트에 첫 필드를 추가해보세요.",
  "IconPicker.search.placeholder.label": "아이콘 검색",
  "IconPicker.search.clear.label": "아이콘 검색 지우기",
  "IconPicker.search.button.label": "아이콘 검색 버튼",
  "IconPicker.remove.tooltip": "선택한 아이콘 제거",
  "IconPicker.remove.button": "선택한 아이콘 제거 버튼",
  "IconPicker.emptyState.label": "아이콘을 찾을 수 없습니다",
  "IconPicker.icon.label": "{icon} 아이콘 선택",
  "chat.tooltips.close-chat": "채팅 닫기",
  "chat.tooltips.create-chat": "새 채팅",
  "chat.tooltips.open-chat": "채팅 열기",
  "chat.tooltips.send-message": "보내기",
  "chat.tooltips.stop-generation": "중지",
  "chat.header.default-title": "새 채팅",
  "chat.input.defaults.title": "어떻게 도와드릴까요?",
  "chat.input.defaults.generate": "제품 스키마 생성",
  "chat.input.defaults.ctb": "콘텐츠 타입 빌더에 대해 알려주세요",
  "chat.input.defaults.strapi": "Strapi에 대해 알려주세요",
  "chat.input.thinking": "Strapi AI가 생각 중입니다...",
  "chat.input.placeholder": "Strapi AI에게 물어보세요...",
  "chat.input.strapi-ai-can-make-errors": "Strapi AI는 오류를 만들 수 있습니다.",
  "chat.messages.error": "문제가 발생했습니다.",
  "chat.code-upload.header": "Next.js 애플리케이션 가져오기",
...
//# sourceMappingURL=ko.json-GZ3QUN4O.js.map
