...
// ../node_modules/.pnpm/@strapi+content-type-builder@5.46.0_022ec6a24b75ab97ce8f278e4673eb1f/node_modules/@strapi/content-type-builder/dist/admin/translations/nl.json.mjs
...
var nl = {
  ...
  configurations,
  "contentType.apiId-plural.description": "API ID in meervoudsvorm",
  "contentType.apiId-plural.label": "API ID (Meervoud)",
  "contentType.apiId-singular.description": "UID gebruikt om API-routes en database tabel/collectie te genereren",
  "contentType.apiId-singular.label": "API ID (Enkelvoud)",
  ...
  "error.validation.enum-regex": "Ten minste één waarde is ongeldig. Waarden moeten ten minste één alfabetisch teken hebben vóór het eerste voorkomen van een cijfer.",
  "error.validation.minSupMax": "Kan niet superieur zijn",
  "error.validation.positive": "Moet een positief getal zijn",
  "error.validation.regex": "Regex patroon is ongeldig",
  ...
  "form.attribute.item.date.type.datetime": "datum-tijd (bijv.: 01/01/{currentYear} 00:00 AM)",
  "form.attribute.item.date.type.time": "tijd (bijv.: 00:00 AM)",
  ...
  "form.attribute.item.text.regex": "RegExp patroon",
  ...
  "form.attribute.media.allowed-types.option-videos": "Video's",
  ...
  "modalForm.collectionType.header-create": "Maak een collectie type",
  ...
  "popUpForm.navContainer.base": "Basis instellingen",
  "popUpWarning.bodyMessage.cancel-modifications": "Weet je zeker dat je je wijzigingen wilt annuleren?",
  "popUpWarning.bodyMessage.cancel-modifications.with-components": "Weet je zeker dat je je wijzigingen wilt annuleren? Sommige componenten zijn gemaakt of gewijzigd...",
  ...
  "prompt.unsaved": "Weet je zeker dat je deze pagina wilt verlaten? Alle wijzigingen gaan verloren.",
  ...
  "relation.oneToMany": "behoort tot veel",
...
//# sourceMappingURL=nl.json-5PO23E6V.js.map
