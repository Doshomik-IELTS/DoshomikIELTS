      ...
      <div className="container mx-auto lg:max-w-screen-xl md:max-w-screen-md px-4">
        <div className="grid grid-cols-1 lg:grid-cols-12 items-center gap-8">
          <div className="col-span-6 flex flex-col gap-8">
            <div className="flex gap-2 mx-auto lg:mx-0">
              ...
              <p className="text-success text-sm font-semibold text-center lg:text-start">
                Basic English to IELTS readiness
              </p>
            </div>
            <h1 className="text-midnight-text text-4xl sm:text-5xl font-semibold">
              Advance your IELTS skills with DOshomik.
            </h1>
            <h3 className="text-black/70 text-lg">
              Build skills with owned resources, practise each IELTS module, complete original mock tests, and see transparent unofficial band estimates.
            </h3>
            <div className="relative rounded-full">
              ...
              <Link
                href="/resources"
                className="bg-secondary p-5 rounded-full absolute right-2 top-2 transition hover:bg-primary"
          ...
          <div className="col-span-6 flex justify-center">
            <Image
              src="/images/banner/doshomik-ielts-hero.png"
