...
const courseData = [
  {
    ...
    imgSrc: "/images/courses/course-1.webp",
    students: 150,
    classes: 12,
    price: 0,
    rating: 4.4,
  },
  {
    ...
    imgSrc: "/images/courses/course-2.webp",
    students: 130,
    classes: 12,
    price: 0,
    rating: 4.5,
  },
  {
    ...
    imgSrc: "/images/courses/course-3.webp",
    students: 120,
    classes: 12,
    price: 0,
    rating: 5,
  ...
  return (
    <>
      ...
      {Array.from({ length: emptyStars }).map((_, i) => (
        <Icon key={`empty-${i}`} icon="tabler:star-filled" className="text-gray-300 text-xl inline-block" />
      ))}
    </>
  );
};
                ...
                <div className="px-3 pt-6">
                  ...
                  <div className="flex justify-between items-center py-6 border-b border-slate-200">
                    <div className="flex items-center gap-4">
                      <h3 className="text-primary text-2xl font-medium">{items.rating}</h3>
                  ...
                  <div className="flex justify-between pt-6">
                    <div className="flex gap-4">
                      ...
                      />
                      <h3 className="text-base font-medium text-black/75">{items.classes} exercises</h3>
                    </div>
                    <div className="flex gap-4">
                      <Icon
                        ...
                        className="text-primary text-xl inline-block"
                      />
                      <h3 className="text-base font-medium text-black/75">{items.students} learners</h3>
                    </div>
                  </div>
                </div>
              </div>
