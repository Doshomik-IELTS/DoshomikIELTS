...
- Name: auth-guard.spec.ts >> route protection >> logged-out admin route redirects to login with next path
- Location: tests/e2e/auth-guard.spec.ts:11:7
...
Call log:
  - navigating to "http://127.0.0.1:3100/admin", waiting until "load"
